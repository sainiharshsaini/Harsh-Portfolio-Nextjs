        ...
        >
            <div className="max-w-7xl mx-auto flex flex-col gap-4">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 my-6"
                >
                    {serviceData.map(({ icon, title, description }, index) => (
                        ...
                        >
                            <BorderTrail
                                style={{
                                    boxShadow:
                                        '0px 0px 60px 30px color-mix(in oklch, var(--foreground) 40%, transparent), 0 0 100px 60px color-mix(in oklch, var(--background) 40%, transparent), 0 0 140px 90px color-mix(in oklch, var(--background) 30%, transparent)',
                                }}
                                size={100}
                            />
